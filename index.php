        ...
        <div class="container">
          <div class="row">
            ...
            <!--     <p class="text-uppercase">
                ...
                <h2 class="text-uppercase mt-4 mb-5 quote quote_mobile_max">
...
<!--     <section class="feature_area section_gap_top">
            ...
            <div class="owl-carousel active_course">
              <div class="single_course">
                ...
                <div class="course_content">
                  ...
                  <span class="tag mb-4 d-inline-block">Maths</span>
                  <h4 class="mb-3">
                ...
                <!--   <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfFwOSU0xrpERZ7t_KPDFWj2_lPrZ5hO-J8wTRnfP78JqAUpQ/viewform?embedded=true" width="640" height="1031" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe> -->
              ...
              <div class="single_course">
                ...
                <div class="course_content">
                  <!-- <span class="price">$25</span> -->
                  <span class="tag mb-4 d-inline-block">Physics</span>
                  <h4 class="mb-3">
    ...
    <!--================ Start Events Area =================-->
    <div class="events_area" style="background: #e071be;color: white;">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5">
            <div class="main_title">
...
<div class="col-lg-12 col-md-12" style="color: white;">
  ...
  <li>Teaching Style that Grabs Attention of Students,creates Interest in Each Subject</li>
  <li>Monthly Test Series</li>
<li>Solved Question as per Blue Print</li>
<li>Solved Model/Pevious year Question Papers</li>
<li>Personal Attention on Every Student</li>
<li>Doubt Clearing Session at the End of Each Class</li>
<li>Limited Number of Students in a Class</li>
<li>A Hoslistic Approach Towards both the Subjects</li>
</ul>
